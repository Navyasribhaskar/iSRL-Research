...
Peer-reviewed epidemiological(disease, how, what, prevention) papers
(A reasearch paper aldready checked & evaluated
cited by DOT, WHO or FAO)
×NOT Organisations.
...
did it adopt international allergen lists developed from Western population studies?

5) where the FSSAI lest & the epid burden diverge (do not match /differ)
Means:
i)look for place, where the FSSAI allergen list and  Scientific evidence about allergles in India are different from each other.
(ii) Allergens that cause allergies but aren't included FSSAI mandatory allergen list
(iii) Mention allergens that are on FSSAI list but Indian studies,show little evidence
...
1)Best place for Research papers
--Google Scholar
What we will find
•Peer-reviewed journal antilly
...
4)International regulatly standards
